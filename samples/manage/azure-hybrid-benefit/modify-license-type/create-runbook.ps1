<#
.SYNOPSIS
    Creates an Azure Automation account and imports a runbook.
...
if ($null -eq $principalId) {
    ...
    foreach ($assignment in $roleAssignments) {
        ...
        try {
            New-AzRoleAssignment -ObjectId $principalId -RoleDefinitionName $roleName -Scope "/subscriptions/$($context.Subscription.SubscriptionId)"   -ErrorAction Stop  | Out-Null
